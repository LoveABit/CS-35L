...
void* threadfunc (void* idInfoa)
{
    information* idInfo = (information*)idInfoa;
    Vec3 camera_pos;
...
/* for every pixel */
    for( int px= idInfo->id; px< width; px+=nthreads  )
    {
        ...
        for( int py=0; py<height; ++py )
        {
             ...
             */
           // printf( "%.0f %.0f %.0f\n",
	//	    scaled_color[px][py][0], scaled_color[px][py][1], scaled_color[px][py][2] );
	}	
